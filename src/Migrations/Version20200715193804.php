 ...
 */
final class Version20200715193804 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE hours ADD acceptorid_id INT NOT NULL, DROP acceptorid');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE hours ADD acceptorid INT DEFAULT NULL, DROP acceptorid_id, CHANGE timestamp timestamp DATETIME DEFAULT \'current_timestamp()\' NOT NULL, CHANGE overtacceptance overtacceptance INT DEFAULT NULL');
